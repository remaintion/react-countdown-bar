  ...
  _createClass(Topbar, [{
    ...
    value: function setTime() {
      if (this.isMount) {
        ...
        var diff = (0, _moment2.default)(this.props.liveAt).diff((0, _moment2.default)(), 's');
        var d = _moment2.default.duration(diff, 'seconds');
        var days = d.days();
        var hours = d.hours().toString().length !== 1 ? d.hours() : '0' + d.hours();
        var minutes = d.minutes().toString().length !== 1 ? d.minutes() : '0' + d.minutes();
        var seconds = d.seconds().toString().length !== 1 ? d.seconds() : '0' + d.seconds();
