...
var Topbar = function (_React$Component) {
  ...
  _createClass(Topbar, [{
    ...
    value: function setTime() {
      if (this.isMount) {
        var isShow = (0, _moment2.default)().utc().isBefore((0, _moment2.default)(this.props.liveAt));
        var days = (0, _moment2.default)(this.props.liveAt).utc().diff((0, _moment2.default)().utc(), 'days');
        var hours = (0, _moment2.default)((0, _moment2.default)(this.props.liveAt).utc().diff((0, _moment2.default)().utc())).format('HH');
        var minutes = (0, _moment2.default)((0, _moment2.default)(this.props.liveAt).utc().diff((0, _moment2.default)().utc())).format('mm');
        var seconds = (0, _moment2.default)((0, _moment2.default)(this.props.liveAt).utc().diff((0, _moment2.default)().utc())).format('ss');
    ...
    value: function render() {
      ...
      if (this.props.liveAt) {
        ...
        if ((0, _moment2.default)().utc().isAfter((0, _moment2.default)(this.props.liveAt).utc())) {
